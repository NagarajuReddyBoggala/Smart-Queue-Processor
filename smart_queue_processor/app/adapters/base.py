...
class BaseQueueAdapter(ABC):
    ...
    @abstractmethod
    def publish(self, topic: str, message: QueueMessage) -> str:
        """
    ...
    @abstractmethod
    def subscribe(self, topic: str, callback: Callable[[QueueMessage], Any]) -> None:
        """
    ...
    @abstractmethod
    def acknowledge(self, topic: str, message_id: str) -> None:
